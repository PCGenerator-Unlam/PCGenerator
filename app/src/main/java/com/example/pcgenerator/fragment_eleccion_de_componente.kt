 ...
 * Use the [fragment_eleccion_de_componente.newInstance] factory method to
 * create an instance of this fragment.
 */
class fragment_eleccion_de_componente : Fragment() {
...
lateinit var  binding:FragmentEleccionDeComponenteBinding
   ...
   binding= DataBindingUtil.inflate(inflater,R.layout.fragment_eleccion_de_componente,container,false)
        return binding.root
    }
  ...
  binding.btMotherComponentes.setCompoundDrawablesRelativeWithIntrinsicBounds(0,0,R.drawable.marque_el_circulo,0)
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String) =
            fragment_eleccion_de_componente().apply {
